    ...
    pub fn feed(&mut self, basic_op: BasicOp) -> Option<CompoundOp> {
        ...
        match &self.building[..] {
            ...
            [
                ...
                BasicOp(Shift(2)),
                Zero,
                BasicOp(Shift(neg_2_plus_neg_offset /* -258 */)),
                MoveAdd2(move_offset /*256*/, pos_2_plus_pos_offset /*258*/),
                BasicOp(Shift(shift_pos_2_plus_pos_offset /*258*/)),
                MoveAdd(move_neg_2_plus_neg_offset /*-258*/),
                BasicOp(Shift(-1)),
                BasicOp(LoopStart),
                BasicOp(ChangeBy(u8::MAX)),
                BasicOp(Shift(-1)),
